package com.mobile.nowchat.Fragment
...
import com.mobile.nowchat.databinding.FragmentHomeBinding
import com.mobile.nowchat.databinding.FragmentProfileBinding
    ...
    private val getContent =
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result: ActivityResult ->
            if(result.resultCode == AppCompatActivity.RESULT_OK) {
                ...
                binding.profileImageview.setImageURI(imageUri) //이미지 뷰를 바꿈
